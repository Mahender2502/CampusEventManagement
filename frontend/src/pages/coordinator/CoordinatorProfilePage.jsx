...
import { Loader2, CheckCircle2, AlertCircle, Save, Pencil, X } from 'lucide-react'
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-semibold text-slate-900">Coordinator Profile</h1>
          <p className="mt-1 text-sm text-slate-600">Manage your coordinator account information</p>
        </div>
        {!isEditing && (
          <button
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="space-y-6">
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            <h2 className="text-sm font-semibold text-slate-900">Account Role</h2>
            <div className="mt-4">
            ...
            <p className="mt-4 text-xs text-slate-500">
              You are the coordinator for your assigned club. You can manage its events and members.
            </p>
          </div>
        </div>
      </div>
